...
var idScope = '0ne0000BAB3';
var registrationId = 'myid';
var deviceCert = {
  cert: fs.readFileSync('./keys/leaf/myid/_fullchain.pem').toString(),
  key: fs.readFileSync('./keys/leaf/myid/_key.pem').toString()
};
